  ...
  case EtapaWorkFlow.Status of
    NAO_INICIADA:
      begin
        ...
        TextNomeEtapaWorkFlow.TextSettings.FontColor := TAlphaColorRec.Black;
      end;

    EM_ANDAMENTO:
      begin
        CircleStatusEtapaWorkFlow.Fill.Color := TAlphaColorRec.Goldenrod;
        RectangleAnterior.Fill.Color := TAlphaColorRec.Goldenrod;
        RectangleProximo.Fill.Color := TAlphaColorRec.Goldenrod;
        TextNomeEtapaWorkFlow.TextSettings.FontColor := TAlphaColorRec.Black;
      end;
    CONCLUIDA:
      begin
